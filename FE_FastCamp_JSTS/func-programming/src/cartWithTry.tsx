...
// Item 에 대한 Array를 Parsed Item에 대한 Array로 바꿔보자.(ch6-8)
export type ArrayItem = Array<T.Try<ParsedItem, ParsedError>>;
...
const totalCalculator = (
	...
	return (
		T.KeepSuccess(list)
			// 1. 재고가 있는 상품만 분류하기
			// Array<T.Try<ParseError, ParsedItem>> => Array<ParsedItem> -> try.ts에서 만들겠다.
			.filter((item) => {
				try {
					// parseItem(item);
...
export const CartList = (cartList: ArrayItem) => {
